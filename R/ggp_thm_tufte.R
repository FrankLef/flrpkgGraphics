#' GGplot \emph{clean theme} with \code{ggthemes::theme_tufte}
#'
#' GGplot \emph{clean theme} with \code{ggthemes::theme_tufte}.
#'
#' Use the \code{ggthemes::theme_tufte} with a clean format.
#'
...
#' TODO
#' }
ggp_thm_tufte <- function(base_family = "Noto Sans Display",
  ...
  ggthemes::theme_tufte(base_family = base_family) +
    ggplot2::theme(
